...
def data_load_train(base_path=ParSet['TRAIN_PATH'], nii_index=0):
	...
	xs, ys, label_aux1, label_aux2, label_aux3 = [item[np.newaxis, ..., np.newaxis] for item in [xs, ys, label_aux1, label_aux2, label_aux3]]

	return xs, ys, label_aux1, label_aux2, label_aux3
